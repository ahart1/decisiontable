...
makeDecisionTable(data = data_df,
                  ...
                  visualRank = "TRUE",
                  OutputDirectory = here::here(),
                  OutputFileName = paste("Readme_Fig1"),
                  GraphicTitle = "Example Decision Table",
                  RowHeader = "Make comparisons across rows",
                  ColumnHeader = "Make comparisons \n across columns",
                  figureWidth = 650,
                  figureHeight = 800)
```
![Decision table created using the dataframe option](here::here("Readme_Fig1.png"))
...
```
![Decision table created using the dataframe option](here::here("Readme_Fig2.png"))
