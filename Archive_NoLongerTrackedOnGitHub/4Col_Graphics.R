...
GraphicFormat4Col <- function(Data, SummaryRowOption = "Off"){
  ...
  # NCol = 4
  ##############################
  # graphicLayout <- c(rep(1, (ncol-2)), 2, 3, 4, 5, rep(6, ncol+1), 5, 7, rep(8, ncol), 5, 7, rep(9, ncol), 5, 7, seq(from=10, to=ncol+9), 5, rep(ncol+10, ncol+1), 5)
  # loopnums <- seq(from=(ncol+10), to=ncol+10+nrow*(ncol+2), by=(ncol+2))
  # for(inum in loopnums[-length(loopnums)]){
  #   graphicLayout <- c(graphicLayout, seq(from=inum+1, to=inum+ncol+1), 5)
  #   graphicLayout <- c(graphicLayout, rep(inum+ncol+2, ncol+1), 5)
  # }
  # graphicFormat$graphicLayout <- graphicLayout
  # graphicFormat$graphicNrow <- 6+nrow(data)*2
  # graphicFormat$graphicNcol <- ncol+2
