...
makeDecisionTable(data = data_df,
                  ...
                  figureHeight = 800)
```
![Decision table created using the dataframe option](/Users/ahart2/Research/decisiontable/Readme_Fig1.png)
...
```
![Decision table created using the dataframe option](/Users/ahart2/Research/decisiontable/Readme_Fig2.png)
